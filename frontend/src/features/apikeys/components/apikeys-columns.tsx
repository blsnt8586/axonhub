...
import { ApiKeyBudgetCell, ApiKeyCell } from './apikeys-column-cells';
...
export const createColumns = (t: ReturnType<typeof useTranslation>['t'], canWrite: boolean = true, canViewCreators: boolean = false): ColumnDef<ApiKey>[] => [
  ...
  {
    id: 'budget',
    header: ({ column }) => <DataTableColumnHeader column={column} title={t('apikeys.columns.budget')} />,
    cell: ({ row }) => <ApiKeyBudgetCell apiKey={row.original} />,
    enableSorting: false,
  },
  {
