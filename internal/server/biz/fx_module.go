...
var Module = fx.Module("biz",
	...
	fx.Provide(NewUserWorkspaceSummaryService),
	fx.Provide(NewUserWorkspaceService),
	fx.Provide(NewUserAPIKeyService),
	fx.Provide(NewUserPlaygroundService),
	fx.Provide(NewUserUsageService),
