...
type PaymentProviderInstanceQuery struct {
	...
	loadTotal              []func(context.Context, []*PaymentProviderInstance) error
...
func (_q *PaymentProviderInstanceQuery) QueryPaymentOrders() *PaymentOrderQuery {
...
func (_q *PaymentProviderInstanceQuery) QueryPaymentEvents() *PaymentEventQuery {
...
func (_q *PaymentProviderInstanceQuery) WithPaymentOrders(opts ...func(*PaymentOrderQuery)) *PaymentProviderInstanceQuery {
	query := (&PaymentOrderClient{config: _q.config}).Query()
...
func (_q *PaymentProviderInstanceQuery) WithPaymentEvents(opts ...func(*PaymentEventQuery)) *PaymentProviderInstanceQuery {
	query := (&PaymentEventClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *PaymentProviderInstanceQuery) prepareQuery(ctx context.Context) error {
	...
	if paymentproviderinstance.Policy == nil {
		return errors.New("ent: uninitialized paymentproviderinstance.Policy (forgotten import ent/runtime?)")
	}
	if err := paymentproviderinstance.Policy.EvalQuery(ctx, _q); err != nil {
		return err
	}
	return nil
}
...
func (_q *PaymentProviderInstanceQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*PaymentProviderInstance, error) {
	...
	if query := _q.withPaymentOrders; query != nil {
		if err := _q.loadPaymentOrders(ctx, query, nodes,
			func(n *PaymentProviderInstance) { n.Edges.PaymentOrders = []*PaymentOrder{} },
			func(n *PaymentProviderInstance, e *PaymentOrder) {
	...
	if query := _q.withPaymentEvents; query != nil {
		if err := _q.loadPaymentEvents(ctx, query, nodes,
			func(n *PaymentProviderInstance) { n.Edges.PaymentEvents = []*PaymentEvent{} },
			func(n *PaymentProviderInstance, e *PaymentEvent) {
				n.Edges.PaymentEvents = append(n.Edges.PaymentEvents, e)
			}); err != nil {
			return nil, err
		}
	}
	for name, query := range _q.withNamedPaymentOrders {
		if err := _q.loadPaymentOrders(ctx, query, nodes,
			func(n *PaymentProviderInstance) { n.appendNamedPaymentOrders(name) },
			func(n *PaymentProviderInstance, e *PaymentOrder) { n.appendNamedPaymentOrders(name, e) }); err != nil {
			return nil, err
		}
	}
	for name, query := range _q.withNamedPaymentEvents {
		if err := _q.loadPaymentEvents(ctx, query, nodes,
			func(n *PaymentProviderInstance) { n.appendNamedPaymentEvents(name) },
			func(n *PaymentProviderInstance, e *PaymentEvent) { n.appendNamedPaymentEvents(name, e) }); err != nil {
			return nil, err
		}
	}
...
func (_q *PaymentProviderInstanceQuery) loadPaymentOrders(ctx context.Context, query *PaymentOrderQuery, nodes []*PaymentProviderInstance, init func(*PaymentProviderInstance), assign func(*PaymentProviderInstance, *PaymentOrder)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*PaymentProviderInstance)
	for i := range nodes {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(paymentorder.FieldProviderInstanceID)
	}
	query.Where(predicate.PaymentOrder(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(paymentproviderinstance.PaymentOrdersColumn), fks...))
	}))
	...
	for _, n := range neighbors {
		fk := n.ProviderInstanceID
		if fk == nil {
			return fmt.Errorf(`foreign-key "provider_instance_id" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "provider_instance_id" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
}
func (_q *PaymentProviderInstanceQuery) loadPaymentEvents(ctx context.Context, query *PaymentEventQuery, nodes []*PaymentProviderInstance, init func(*PaymentProviderInstance), assign func(*PaymentProviderInstance, *PaymentEvent)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*PaymentProviderInstance)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(paymentevent.FieldProviderInstanceID)
	}
	query.Where(predicate.PaymentEvent(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(paymentproviderinstance.PaymentEventsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *PaymentProviderInstanceQuery) Modify(modifiers ...func(s *sql.Selector)) *PaymentProviderInstanceSelect {
...
func (_q *PaymentProviderInstanceQuery) WithNamedPaymentOrders(name string, opts ...func(*PaymentOrderQuery)) *PaymentProviderInstanceQuery {
	query := (&PaymentOrderClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
// edge with the given name. The optional arguments are used to configure the query builder of the edge.
func (_q *PaymentProviderInstanceQuery) WithNamedPaymentEvents(name string, opts ...func(*PaymentEventQuery)) *PaymentProviderInstanceQuery {
	query := (&PaymentEventClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
// Modify adds a query modifier for attaching custom logic to queries.
func (_s *PaymentProviderInstanceSelect) Modify(modifiers ...func(s *sql.Selector)) *PaymentProviderInstanceSelect {
