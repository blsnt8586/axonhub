...
const (
	// Label holds the string label denoting the usagehourlyaggregate type in the database.
	Label = "usage_hourly_aggregate"
	...
	// Table holds the table name of the usagehourlyaggregate in the database.
	Table = "usage_hourly_aggregates"
)

// Columns holds all SQL columns for usagehourlyaggregate fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
func RequestTypeValidator(rt RequestType) error {
	...
	case RequestTypeChat, RequestTypeImage, RequestTypeVideo, RequestTypeEmbedding, RequestTypeAudio, RequestTypeOther:
		return nil
	default:
		return fmt.Errorf("usagehourlyaggregate: invalid enum value for request_type field: %q", rt)
	}
}
...
func StatusValidator(s Status) error {
	...
	case StatusPending, StatusCharged, StatusSkipped, StatusFailed, StatusRefunded:
		return nil
	default:
		return fmt.Errorf("usagehourlyaggregate: invalid enum value for status field: %q", s)
	}
}

// OrderOption defines the ordering options for the UsageHourlyAggregate queries.
