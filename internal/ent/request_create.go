...
func (_c *RequestCreate) AddUpstreamAccountSwitchHistoryIDs(ids ...int) *RequestCreate {
...
func (_c *RequestCreate) AddUpstreamAccountSwitchHistories(v ...*UpstreamAccountSwitchHistory) *RequestCreate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
