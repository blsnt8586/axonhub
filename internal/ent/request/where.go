...
func HasUpstreamAccountSwitchHistories() predicate.Request {
	return predicate.Request(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasUpstreamAccountSwitchHistoriesWith(preds ...predicate.UpstreamAccountSwitchHistory) predicate.Request {
	return predicate.Request(func(s *sql.Selector) {
...
func HasBillingHolds() predicate.Request {
	return predicate.Request(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasBillingHoldsWith(preds ...predicate.BillingHold) predicate.Request {
	return predicate.Request(func(s *sql.Selector) {
